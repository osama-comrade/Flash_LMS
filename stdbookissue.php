        ...
        if(mysqli_num_rows($result1) > 0){
          ...
          if($total_page > 1){
            ...
            if($page > 1){ // show previous button
              $pagination .= '<li class=""><a href="stdbookissue.php?page='.($page - 1).'">Prev</a></li>';
            }
            for($i = 1; $i <= $total_page; $i++){
              ...
              $pagination .= '<li class="'.$active.'"><a href="stdbookissue.php?page='.$i.'">'.$i.'</a></li>';
            }
            if($total_page > $page){ //show next button
              $pagination .= '<li class=""><a href="stdbookissue.php?page='.($page + 1).'">Next</a></li>';
            }
            $pagination .= "</ul>";
            echo $pagination;
          }
